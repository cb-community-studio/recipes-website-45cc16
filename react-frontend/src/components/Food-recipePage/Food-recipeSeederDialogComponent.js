...
import seederData from "./food-recipe.seeder.json";
...
const Food-recipeSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(Food-recipeSeederDialogComponent);
